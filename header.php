		...
		<div id="top-header">
			<div class="container">
				<ul class="header-links pull-left">
					<li><a href="#"><i class="fa fa-phone"></i> +966 58 235 0407</a></li>
					<li><a href="#"><i class="fa fa-envelope-o"></i> i5aledzeid@gmail.com</a></li>
					<li><a href="#"><i class="fa fa-map-marker"></i>Saudi Arabia</a></li>
				</ul>
							...
							echo '
                                <div class="dropdownn">
									...
									<div class="dropdownn-content">
										<!--<a href="myaccounts.php" data-toggle="modal" data-target="#profile">
										...
										<a href="myorders.php">
											<i class="fa fa-shopping-basket" aria-hidden="true"></i>My Order
										</a>
										<a href="logout.php">
