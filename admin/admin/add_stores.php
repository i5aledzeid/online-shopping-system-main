...
if (isset($_POST['btn_save'])) {
  ...
  if ($picture_type == "image/jpeg" || $picture_type == "image/jpg" || $picture_type == "image/png" || $picture_type == "image/gif") {
    ...
    mysqli_query($con, "INSERT INTO `stores` (title, subtitle, image, status, created_at) 
    values ('$product_name','$details','$pic_name','$tags', '$price')") or die("query incorrect");
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <label>Store Created Date</label>
                    <!-- Year Month Day -->
                    <input type="date" id="price" name="price" required class="form-control" value="1996-06-09">
                  </div>
                </div>
              </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <select id="product_type" name="product_type" class="form-control">
                      <option value="" style="color:black;">إختر تصنيف</option>
                      <?php
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <select id="brand" name="brand" class="form-control">
                      <option value="" style="color:black;">إختر العلامة التجارية</option>
                      <?php
